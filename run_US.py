...
from modeling import DialogElectraScoring
...
def main():
    ...
    if os.path.exists(args.cache_data):
        ...
        with open("data/us_corpus.json") as f:
            corpus = json.load(f)
    ...
    model = DialogElectraScoring(config=model_config)
    ...
    for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
        ...
        model.save_pretrained(f"output/electra_us_{epoch}")
