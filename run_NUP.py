...
from modeling import DialogElectraNUP
...
def convert_examples_to_features_nup(examples, max_seq_length, max_utterance_num,
                                 tokenizer):
...
def main():
    ...
    parser.add_argument("--cache_data",
                        default='data/nup_cache_data.pk',
                        type=str,
    ...
    if os.path.exists(args.cache_data):
        ...
        with open("data/nup_corpus.json") as f:
            corpus = json.load(f)
        ...
        train_features = convert_examples_to_features_nup(train_examples, args.max_seq_length, args.max_utterance_num, tokenizer)
        eval_features = convert_examples_to_features_nup(dev_examples, args.max_seq_length, args.max_utterance_num, tokenizer)
    ...
    model = DialogElectraNUP(config=model_config, num_decoupling=args.num_decouple, num_rnn=args.num_rnn)
    ...
    for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
        ...
        model.save_pretrained(f"output/electra_nup_{epoch}")
