    ...
    def __init__(self,
        ...
        for i in range(num_layers):
            for j in range(self.direction):
                layer = LayerNormLSTMLayer(input_size * self.direction,
                                           hidden_size,
                                           dropout=dropout,
                                           cln=cln)
                layers.append(layer)
...
class LayerNormLSTMLayer(LSTMcell):
    ...
    def __init__(self,
                 ...
                 learnable=True,
                 cln=True):
        super(LayerNormLSTMLayer, self).__init__(input_size=input_size,
